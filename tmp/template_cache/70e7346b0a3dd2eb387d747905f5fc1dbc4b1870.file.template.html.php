<?php /* Smarty version Smarty-3.1.14, created on 2017-06-24 18:08:47
         compiled from "D:\xampp\htdocs\thietkeweb\app\template\backend\template.html" */ ?>
<?php /*%%SmartyHeaderCode:24195594a6ffa8f4066-76630357%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '70e7346b0a3dd2eb387d747905f5fc1dbc4b1870' => 
    array (
      0 => 'D:\\xampp\\htdocs\\thietkeweb\\app\\template\\backend\\template.html',
      1 => 1498302524,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '24195594a6ffa8f4066-76630357',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.14',
  'unifunc' => 'content_594a6ffaab9bb2_41515560',
  'variables' => 
  array (
    'body' => 0,
    'logo' => 0,
...
<?php if ($_valid && !is_callable('content_594a6ffaab9bb2_41515560')) {function content_594a6ffaab9bb2_41515560($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
  <head>
                  ...
                  <div class="x_content">                    
					 <div class="row">
					 	...
					 	<form id="form_setting" action="" class="form-horizontal form-label-left" enctype="multipart/form-data">
					 		 <!--body -->
					 		 <?php $_smarty_tpl->tpl_vars['module_name'] = new Smarty_variable('Body', null, 0);?> 
					 		 <?php $_smarty_tpl->tpl_vars['data_list'] = new Smarty_variable($_smarty_tpl->tpl_vars['body']->value, null, 0);?> 
	                    	 <?php echo $_smarty_tpl->getSubTemplate ('template/module.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>

	                    	 <!--end body -->
	                    	 <!--logo -->
					 		 <?php $_smarty_tpl->tpl_vars['module_name'] = new Smarty_variable('Logo', null, 0);?> 
					 		 <?php $_smarty_tpl->tpl_vars['data_list'] = new Smarty_variable($_smarty_tpl->tpl_vars['logo']->value, null, 0);?> 
	                    	 <?php echo $_smarty_tpl->getSubTemplate ('template/module.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>

	                    	 <!--end logo -->
					 		 <!--menu -->
					 		 <?php $_smarty_tpl->tpl_vars['module_name'] = new Smarty_variable('Menu top', null, 0);?> 
					 		 <?php $_smarty_tpl->tpl_vars['data_list'] = new Smarty_variable($_smarty_tpl->tpl_vars['menu_top']->value, null, 0);?> 
	                    	 <?php echo $_smarty_tpl->getSubTemplate ('template/module.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>

	                    	 <!--end menu -->
					 		 <!--slide -->
					 		 <?php $_smarty_tpl->tpl_vars['module_name'] = new Smarty_variable('Slide top', null, 0);?> 
					 		 <?php $_smarty_tpl->tpl_vars['data_list'] = new Smarty_variable($_smarty_tpl->tpl_vars['slide_top']->value, null, 0);?> 
	                    	 <?php echo $_smarty_tpl->getSubTemplate ('template/module.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>

	                    	 <!--end slide -->
	                    	 <!--content -->
					 		 <?php $_smarty_tpl->tpl_vars['module_name'] = new Smarty_variable('Content', null, 0);?> 
					 		 <?php $_smarty_tpl->tpl_vars['data_list'] = new Smarty_variable($_smarty_tpl->tpl_vars['content']->value, null, 0);?> 
	                    	 <?php echo $_smarty_tpl->getSubTemplate ('template/module.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>

	                    	 <!--end content -->
	                    	 <!--footer -->
					 		 <?php $_smarty_tpl->tpl_vars['module_name'] = new Smarty_variable('Footer', null, 0);?> 
					 		 <?php $_smarty_tpl->tpl_vars['data_list'] = new Smarty_variable($_smarty_tpl->tpl_vars['footer']->value, null, 0);?> 
	                    	 <?php echo $_smarty_tpl->getSubTemplate ('template/module.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
