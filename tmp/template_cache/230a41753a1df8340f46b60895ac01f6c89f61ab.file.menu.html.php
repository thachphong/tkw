<?php /* Smarty version Smarty-3.1.14, created on 2017-06-16 20:53:37
         compiled from "D:\xampp\htdocs\thietkeweb\app\template\backend\menu.html" */ ?>
<?php /*%%SmartyHeaderCode:279875943e2e16f6158-75868120%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '230a41753a1df8340f46b60895ac01f6c89f61ab' => 
    array (
      0 => 'D:\\xampp\\htdocs\\thietkeweb\\app\\template\\backend\\menu.html',
      1 => 1493054787,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '279875943e2e16f6158-75868120',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5943e2e1aada28_69526932',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5943e2e1aada28_69526932')) {function content_5943e2e1aada28_69526932($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
  <head>
...
?>
                          ...
                          <?php if ($_smarty_tpl->tpl_vars['item']->value['menu_level']==1){?>
                          	<td colspan="3" id="name_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['menu_id'], ENT_QUOTES, 'UTF-8');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['menu_name'], ENT_QUOTES, 'UTF-8');?>
</td>
                          <?php }elseif($_smarty_tpl->tpl_vars['item']->value['menu_level']==2){?>
                          	<td></td>
                          	<td colspan="2"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['menu_name'], ENT_QUOTES, 'UTF-8');?>
</td>
                          <?php }else{ ?>
                          	<td></td>
                          	<td></td>
                          	<td ><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['menu_name'], ENT_QUOTES, 'UTF-8');?>
</td>
                          <?php }?>
                           
                          <td>
                          	<?php if ($_smarty_tpl->tpl_vars['item']->value['menu_level']!=3){?>
                          	<button class="btn btn-info btn-xs add_child" id="add_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['menu_id'], ENT_QUOTES, 'UTF-8');?>
">Thêm menu con</button>
                          	<?php }?>
                          </td>                         
                          <td>
                          ...
                          <td>
                          	<button class="btn btn-warning btn-xs btn_edit" id="edit_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['menu_id'], ENT_QUOTES, 'UTF-8');?>
">Sửa</button>
                          </td>
                          <td>
                          	<button class="btn btn btn-danger btn-xs btn_delete" id="del_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['menu_id'], ENT_QUOTES, 'UTF-8');?>
">Xóa</button>
                          </td>
                        </tr>
                      <?php } ?>                        
