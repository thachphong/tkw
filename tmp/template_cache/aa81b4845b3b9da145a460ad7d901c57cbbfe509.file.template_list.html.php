<?php /* Smarty version Smarty-3.1.14, created on 2017-06-25 10:50:43
         compiled from "D:\xampp\htdocs\thietkeweb\app\template\backend\template_list.html" */ ?>
<?php /*%%SmartyHeaderCode:23504594e92ca819618-60159436%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'aa81b4845b3b9da145a460ad7d901c57cbbfe509' => 
    array (
      0 => 'D:\\xampp\\htdocs\\thietkeweb\\app\\template\\backend\\template_list.html',
      1 => 1498362638,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '23504594e92ca819618-60159436',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.14',
  'unifunc' => 'content_594e92ca92d921_25041653',
  'variables' => 
  array (
    'list' => 0,
    'key' => 0,
...
<?php if ($_valid && !is_callable('content_594e92ca92d921_25041653')) {function content_594e92ca92d921_25041653($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
  <head>
          ...
          <div class="">
            ...
            <div class="row">              
			  <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Danh sách template<!--<small>Users</small>--></h2>
...
?>
                          ...
                          <td>
                          	<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['template_no'], ENT_QUOTES, 'UTF-8');?>

                          </td> 
                           
                          <td>
                          	<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['template_name'], ENT_QUOTES, 'UTF-8');?>

                          </td>                         
                          <td>
                          	
                          	<span class="fa <?php if ($_smarty_tpl->tpl_vars['item']->value['active']==0){?>fa-square-o<?php }else{ ?>fa-check-square<?php }?>" style="font-size: 16px;"></span>
                          	
                          </td>
                          <td>
                          	<button class="btn btn-warning btn-xs btn_edit" id="edit_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['template_id'], ENT_QUOTES, 'UTF-8');?>
">Sửa</button>
                          </td>
                          <td>
                          	<button class="btn btn btn-danger btn-xs btn_delete" id="del_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['template_id'], ENT_QUOTES, 'UTF-8');?>
">Xóa</button>
                          </td>
                        </tr>
                      <?php } ?>                        
...
template/new" ,{'silde_id':''},function(html){
            	Pho_modal(html,"Thêm template",700);
            });
...
template/templateupdate" ,arr,function(datas){
				if(datas.status =="OK"){
					Pho_modal_close("modal1");
...
template/edit/"+ id ,null,function(html){
                /*Pho_modal({
		        		template:html,
				        closeClick: false,
				        closable: true, 
            	...
            	Pho_modal(html,"Sửa Template",700);
            });
        });
        ...
        $(document).on('click','.add_child',function(event){
        	var id = $(this).attr('id');
	        	id = id.replace("add_","");			
            Pho_html_ajax('GET',"<?php echo htmlspecialchars(@constant('ACW_BASE_URL'), ENT_QUOTES, 'UTF-8');?>
slides/addchild/"+ id ,null,function(html){
                /*Pho_modal({
		        		template:html,
				        closeClick: false,
				        closable: true, 
