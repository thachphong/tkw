<?php /* Smarty version Smarty-3.1.14, created on 2017-06-25 15:26:16
         compiled from "D:\xampp\htdocs\thietkeweb\app\template\backend\template_content.html" */ ?>
<?php /*%%SmartyHeaderCode:10311594f3528806411-12592914%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6e6a2a9f820289796e7900f2815abcdce91f0b1d' => 
    array (
      0 => 'D:\\xampp\\htdocs\\thietkeweb\\app\\template\\backend\\template_content.html',
      1 => 1498379173,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '10311594f3528806411-12592914',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.14',
  'unifunc' => 'content_594f35288cf873_96365151',
  'variables' => 
  array (
    'list' => 0,
    'item' => 0,
...
<?php if ($_valid && !is_callable('content_594f35288cf873_96365151')) {function content_594f35288cf873_96365151($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
  <head>
          ...
          <div class="">
            ...
            <div class="row">              
			  <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Danh sách content<!--<small>Users</small>--></h2>
...
?>
                      	<tr>
                          <td><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['sort'], ENT_QUOTES, 'UTF-8');?>
</td>
                          <td>
                          	<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['section_id'], ENT_QUOTES, 'UTF-8');?>

                          </td>                         
                          <td>
                          	<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['column_id'], ENT_QUOTES, 'UTF-8');?>

                          </td>
                          <td>
                          	<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['con_name'], ENT_QUOTES, 'UTF-8');?>

                          </td>
                          <td>
                          	<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['outner_name'], ENT_QUOTES, 'UTF-8');?>

                          </td>
                          <td>
                          	<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['inner_name'], ENT_QUOTES, 'UTF-8');?>

                          </td>
                          <td>
                          	<button class="btn btn-warning btn-xs btn_edit" id="edit_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['con_id'], ENT_QUOTES, 'UTF-8');?>
">Sửa</button>
                          </td>
                          <td>
                          	<button class="btn btn btn-danger btn-xs btn_delete" id="del_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['con_id'], ENT_QUOTES, 'UTF-8');?>
">Xóa</button>
                          </td>
                        </tr>
                      <?php } ?>                        
...
templatecontent/new" ,{},function(html){
                
            	Pho_modal(html,"Thêm Content",700);
            });
...
templatecontent/update" ,arr,function(datas){
				if(datas.status =="OK"){
					Pho_modal_close("modal1");
...
templatecontent/delete/" + id,null ,function(datas){
					if(datas.status == "OK"){
						//Pho_modal_close("modal1");
						//Pho_message_box("Thông báo",datas.msg);
...
templatecontent/edit/"+ id ,null,function(html){
                /*Pho_modal({
		        		template:html,
				        closeClick: false,
				        closable: true, 
        ...
        $(document).on('click','.add_child',function(event){
        	var id = $(this).attr('id');
	        	id = id.replace("add_","");			
            Pho_html_ajax('GET',"<?php echo htmlspecialchars(@constant('ACW_BASE_URL'), ENT_QUOTES, 'UTF-8');?>
templatecontent/addchild/"+ id ,null,function(html){
                /*Pho_modal({
		        		template:html,
				        closeClick: false,
				        closable: true, 
